...
\begin{figure}[htbp]
  \centering
  \includegraphics[width=0.7\textwidth]{pictures/iot1.png}
...
\begin{figure}[htbp]
  \centering
  \includegraphics[width=0.8\textwidth]{pictures/robots.png}
...
\begin{figure}[htbp]
  \centering
  \includegraphics[width=0.2\textwidth]{pictures/parts.png}
...
\begin{figure}[htbp]
  \centering
  \includegraphics[width=0.8\textwidth]{pictures/assrules.png}
...
\begin{figure}[H]
  \centering
  \includegraphics[width=0.7\textwidth]{pictures/process_direction.drawio.png}
...
\begin{enumerate}
  ...
  \item \textbf{Assemble part from box on RASS1 - DISPLAY}: The display is assembled on the main PCB. This is the second configured part of the product. The display is one optional part of the product. This factors out one product variant, see \ref{sec:casestudy}.
...
\subsubsection{Concatenation of Datasets}
...
\begin{itemize}
  ...
  \item Only a subset of all performed processes was included (in detail, all \texttt{process_id} \le 26. These processes all have the \texttt{process_type} 'machine', 'feature' or 'endproduct'. The processes with the \texttt{process_type} 'test' and 'transport' were removed. This was done to ensure that only the relevant processes are included in the dataset.
\end{itemize}
